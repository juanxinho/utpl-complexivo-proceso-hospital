            ...
            <li>
                <x-nav-link href="#">
                    <svg class="w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" width="23"width="25" height="24" viewBox="0 0 25 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M22.3241 0.938721H2.68337C1.32079 0.938721 0.228271 2.03124 0.228271 3.39381V18.1244C0.228271 19.4747 1.32079 20.5795 2.68337 20.5795H7.59355V23.0346H17.4139V20.5795H22.3241C23.6744 20.5795 24.7792 19.4747 24.7792 18.1244V3.39381C24.7792 2.03124 23.6744 0.938721 22.3241 0.938721ZM22.3241 18.1244H2.68337V3.39381H22.3241V18.1244Z" fill="#4B4B4C"/>
                        <path d="M14.9588 7.38334H5.13846V9.22466H14.9588V7.38334Z" fill="#4B4B4C"/>
                        <path d="M18.0277 9.22466H19.869V7.38334H18.0277V5.84891H16.1864V10.7591H18.0277V9.22466Z" fill="#4B4B4C"/>
                        <path d="M19.869 12.2935H10.0486V14.1349H19.869V12.2935Z" fill="#4B4B4C"/>
                        <path d="M6.97978 15.6693H8.8211V10.7591H6.97978V12.2935H5.13846V14.1349H6.97978V15.6693Z" fill="#4B4B4C"/>
                    </svg>
            ...
            <li>
                <x-nav-link href="#">
                    <svg class="w-4 h-4 text-gray-500 transition duration-75 dark:text-gray-400 group-hover:text-gray-900 dark:group-hover:text-white" width="23"width="31" height="30" viewBox="0 0 31 30" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                        <path d="M14.5831 19.767C14.5831 20.2755 14.9953 20.6877 15.5037 20.6877C16.0122 20.6877 16.4244 20.2755 16.4244 19.767V6.87775C16.4244 6.36929 16.0122 5.95709 15.5037 5.95709C14.9953 5.95709 14.5831 6.36929 14.5831 6.87775L14.5831 19.767Z" fill="#4B4B4C"/>
                        <path d="M9.97976 19.767C9.97976 20.2755 10.392 20.6877 10.9004 20.6877C11.4089 20.6877 11.8211 20.2755 11.8211 19.767L11.8211 12.4017C11.8211 11.8932 11.4089 11.4811 10.9004 11.4811C10.392 11.4811 9.97976 11.8932 9.97976 12.4017L9.97976 19.767Z" fill="#4B4B4C"/>
                        <path d="M7.21778 22.529C6.70931 22.529 6.29712 22.9412 6.29712 23.4496C6.29712 23.9581 6.70931 24.3703 7.21778 24.3703H23.7897C24.2981 24.3703 24.7103 23.9581 24.7103 23.4496C24.7103 22.9412 24.2981 22.529 23.7897 22.529H7.21778Z" fill="#4B4B4C"/>
                        <path d="M20.107 20.6877C19.5986 20.6877 19.1864 20.2755 19.1864 19.767V12.4017C19.1864 11.8932 19.5986 11.4811 20.107 11.4811C20.6155 11.4811 21.0277 11.8932 21.0277 12.4017V19.767C21.0277 20.2755 20.6155 20.6877 20.107 20.6877Z" fill="#4B4B4C"/>
                    </svg>
