<h2 class="text-2xl font-bold mb-4 dark:text-malachite-300">{{ __('Welcome') }}, {{ Auth::user()->profile->first_name }}!</h2>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-4">
    ...
    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="p-5">
            ...
            <x-button href="{{ route('patient.appointments.create') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
    ...
    <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <div class="p-5">
            ...
            <x-button href="{{ route('appointments.history') }}" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">
                {{ __('View History') }}
            </x-button>
        </div>
    </div>
