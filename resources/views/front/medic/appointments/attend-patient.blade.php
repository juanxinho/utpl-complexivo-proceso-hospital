                        ...
                        @foreach($diagnostics as $index => $diagnostic)
                            <div class="flex mt-2">
                                ...
                                <x-button wire:click.prevent="removeDiagnostic({{ $index }})"
                                          class="ml-2 bg-red-500 hover:bg-red-700 dark:bg-red-300 dark:hover:bg-red-500">-
                                </x-button>
                            </div>
                        @endforeach
            ...
            <div class="max-w-7xl mx-auto px-0 md:p-2">
                <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-lg p-6">
                    <div class="mt-4">
                        ...
                        @endforeach
                        <x-button wire:click.prevent="addPrescriptionItem" class="mt-2">+ Add Item</x-button>
            ...
            <div class="max-w-7xl mx-auto px-0 md:p-2">
                <div class="bg-white dark:bg-gray-900 overflow-hidden shadow-xl sm:rounded-t-lg p-6">
                    ...
                    <div class="mt-4">
                        ...
                        <textarea id="recommendations" wire:model.defer="recommendations"
