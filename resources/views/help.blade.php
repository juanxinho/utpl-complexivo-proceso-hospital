    ...
    <div class="py-2 md:py-12">
        <div class="mx-auto sm:px-6 lg:px-2">
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg p-6">
                <h3 class="text-lg font-medium text-gray-900">Bienvenido a la página de Soporte y Ayuda</h3>
                ...
                <div class="mt-6">
                    ...
                    <p class="mt-2 text-gray-600">
                        Si necesitas ayuda adicional, puedes contactar con nuestro equipo de soporte técnico enviando un correo a <a href="mailto:soporte@example.com" class="text-blue-600">soporte@example.com</a>.
                    </p>
                </div>
            </div>
        </div>
