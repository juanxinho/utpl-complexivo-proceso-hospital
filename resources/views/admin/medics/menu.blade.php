...
<x-menu-link class="mb-4 inline-block hover:underline font-medium py-2 px-4" wire:click="assignRooms()" :active="request()->routeIs('admin.medics.assignroom')">{{ __('Assign Room') }}</x-menu-link>
