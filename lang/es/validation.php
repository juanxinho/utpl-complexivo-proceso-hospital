...
return array (
  ...
  array (
    ...
    'attributes' => [
        ...
        'room_code' => 'código de consultorio',
        'room_name' => 'nombre del consultorio',
        'room_description' => 'descripción del consultorio',
        'room_location' => 'ubicación del consultorio',
        'room_status' => 'estado del consultorio',
        'time_range' => 'rango de tiempo',
        'service_date' => 'fecha de servicio',
        'next_control_date' => 'fecha del próximo control',
        'rating' => 'calificación',
        'reason' => 'motivo',
        'day' => 'día',
    ],
